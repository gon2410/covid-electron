var world_button = document.createElement("a");
world_button.innerHTML = "World"

var north_button = document.createElement("a");
north_button.innerHTML = "North America";

var south_button = document.createElement("a");
south_button.innerHTML = "South America";

var europe_button = document.createElement("a");
europe_button.innerHTML = "Europe";

var oceania_button = document.createElement("a");
oceania_button.innerHTML = "Oceania";

var asia_button = document.createElement("a");
asia_button.innerHTML = "Asia";

var africa_button = document.createElement("a");
...
.then(response => {
    ...
    var body = document.getElementById("button-list");
